...
public class UnSubscription {
    ...
    private String unSubScriptionId; // 冲正订单记录id
    ...
    private List<UnSubscribeService> unSubServiceList;

    public List<UnSubscribeService> getUnSubServiceList() {
        return unSubServiceList;
    }

    public void setUnSubServiceList(List<UnSubscribeService> unSubServiceList) {
        this.unSubServiceList = unSubServiceList;
    }
    ...
    public void setUnSubScriptionId(String unSubScriptionId) {
        this.unSubScriptionId = unSubScriptionId;
    }
