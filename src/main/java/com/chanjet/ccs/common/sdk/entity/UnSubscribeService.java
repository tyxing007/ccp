...
public class UnSubscribeService {
	...
	private String subScribeServiceId; // 子服务冲正订单号
	private String parentId;  // 属于哪个冲正订单号
	private String ccsSubServiceID;	//子服务id
	private List<UnSubServiceDetail> unDetailList;
	...
	public List<UnSubServiceDetail> getUnDetailList() {
		return unDetailList;
	}
	public void setUnDetailList(List<UnSubServiceDetail> unDetailList) {
		this.unDetailList = unDetailList;
	}
